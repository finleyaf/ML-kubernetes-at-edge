...
This chapter presents a replication and analysis of the lightweight anomaly detection approach proposed by Fritzsche et al.~\cite{fritzsche2024lightweight} for edge-based Kubernetes clusters. The goal is not only to reproduce reported behaviour, but also to evaluate its robustness under realistic edge preprocessing conditions, establishing the evidence base that informs anomaly-source selection in the scheduling pipeline.
