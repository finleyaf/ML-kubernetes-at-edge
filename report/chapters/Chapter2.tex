...
As discussed in Chapter~\ref{chapter1}, lightweight anomaly detection is essential for edge Kubernetes environments operating under resource constraints and dynamic workloads. This section replicates the K-means and NSA detection approach of Fritzsche et al.~\cite{fritzsche2024lightweight} under controlled offline conditions to evaluate detector behaviour and sensitivity to preprocessing choices, establishing the evidence base that informs anomaly-source selection in the scheduling pipeline.
